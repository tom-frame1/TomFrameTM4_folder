...
<form name="retrieveBoardGameForm" action="retrieve_assign_validate.php" onsubmit="return validateMemberId()" method="post">

<table class="table">

<tr><td>
Select a Member ID to retrieve their assigned Board Games:
</td><td>
